...
object TrackRepository {
    ...
    val connections = mapOf(
        ...
        TrackItems.PRAIRIE_MEUH_MEUH to listOf(TrackItems.CIRCUIT_MARIO, TrackItems.GOUFFRE_PISSENLIT, TrackItems.ALPES_DK, TrackItems.CHUTES_CHEEP_CHEEP, TrackItems.STADE_PEACH, TrackItems.TROPHEOPOLIS, TrackItems.MONTAGNE_CHOCO, TrackItems.USINE_TOAD, TrackItems.FOURNAISE_OSSEUSE), // VERIFIED
